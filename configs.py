...
BANNED_CHANNELS = list(set(int(x) for x in str(getenv("BANNED_CHANNELS", "-1002904920278")).split())) 
STREAM_LOGS = environ.get('STREAM_LOGS','-1002904920278')
...
class Config(object):
	...
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002904920278")
